    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: b, background: "#FAF8F5", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ background: "white", borderBottom: "1px solid #F0ECE6", height: 60, padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
          <div>
            <div style={{ fontSize: 22, fontWeight: 400, color: "#022350", fontFamily: h }}>Admin Übersicht</div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "24px 32px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
            <a href="/admin/kurse" style={{ background: "white", borderRadius: 14, border: "1px solid #F0ECE6", padding: "22px 24px", textDecoration: "none", display: "block" }}>
            ...
            <a href="/admin/pruefungen" style={{ background: "white", borderRadius: 14, border: "1px solid #F0ECE6", padding: "22px 24px", textDecoration: "none", display: "block" }}>
              <div style={{ fontSize: 28, marginBottom: 10 }}>📝</div>
          ...
          <div style={{ background: "white", borderRadius: 14, border: "1px solid #F0ECE6", overflow: "hidden" }}>
            <div style={{ padding: "18px 24px", borderBottom: "1px solid #F0ECE6", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
