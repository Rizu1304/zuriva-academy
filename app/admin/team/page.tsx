    ...
    <div style={{ display: "flex", height: "100vh", fontFamily: "var(--font-dm-sans, 'DM Sans', sans-serif)", background: "#F0F2F5", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ background: "white", borderBottom: "0.5px solid #dce0e6", height: 60, padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
          <div>
            <div style={{ fontSize: 15, fontWeight: 500, color: "#022350", fontFamily: "var(--font-cormorant, 'Cormorant Garamond', serif)" }}>Team</div>
            <div style={{ fontSize: 12, color: "#9A9AAA" }}>Teammitglieder verwalten und Rollen zuweisen</div>
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={openAdd} style={{ padding: "8px 16px", background: "#022350", color: "white", borderRadius: 9, fontSize: 12.5, fontWeight: 500, border: "none", cursor: "pointer" }}>+ Neues Mitglied</button>
          </div>
        </div>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ background: "#f8f9fb" }}>
                  {["Name", "E-Mail", "Rolle", "Fortschritt", "Credits", "Zuletzt aktiv", "Status", "Aktionen"].map((h) => (
              ...
              <tbody>
                {filtered.length === 0 ? (
                  ...
                  filtered.map((member) => (
                    <tr key={member.id} style={{ borderTop: "0.5px solid #dce0e6" }}>
                      ...
                      <td style={{ padding: "14px 24px" }}>
                        <span style={{
                          ...
                          fontSize: 11,
                          fontWeight: 500,
                          background: member.role === "Admin" ? "#EEF5FF" : member.role === "Instruktor" ? "#E8F5E9" : member.role === "Lernender" ? "#F3E8FF" : "#FFF3E0",
                      ...
                      <td style={{ padding: "14px 24px" }}>
                        <button
                          ...
                          style={{ padding: "5px 12px", borderRadius: 7, border: "0.5px solid #dce0e6", background: "white", fontSize: 12, cursor: "pointer", color: "#022350" }}
                        >
                          Bearbeiten
                        </button>
                      </td>
      ...
      {showModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.35)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 999 }}>
          <div style={{ background: "white", borderRadius: 16, padding: "32px 32px 28px", width: 420, boxShadow: "0 20px 60px rgba(0,0,0,0.15)" }}>
            <div style={{ fontSize: 18, fontWeight: 600, color: "#022350", marginBottom: 24, fontFamily: "var(--font-cormorant, 'Cormorant Garamond', serif)" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 500,
                  cursor: "pointer",
                  background: (editingId === null && (!form.name.trim() || !form.email.trim())) ? "#dce0e6" : "#022350",
